...
var _default = {
  state: {
    projectdetails: {
      ...
      paragraf_2: "In nec sem suscipit, convallis leo vitae, lacinia nibh. Cras amet tellus lectus. Vivamus ipsum nunc, mattis quis nibh id, pellentesque arcu. Donec a pellentesque Cras erat enim, gravida non ante vitae,elequis convallis elit, in viverra felis. Donec ultrices tellus vitae iaculisvd porta. Proin tincidunt ligula id purus porttitor."
    },
    sliderPictures: [{
  ...
  getters: {
    getSliderPictures: function getSliderPictures(state) {
      return state.sliderPictures;
    },
    getProjectDetails: function getProjectDetails(state) {
