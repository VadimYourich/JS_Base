...
const num1 = prompt("Введите число равное или меньше 1");
if (+num1 <= 1) {
  alert("Ok");
} else {
  alert("Mistake");
}
const num2 = prompt("Введите число равное или больше 3");
if (+num2 >= 3) {
  alert("Ok");
} else {
  alert("Mistake");
...
console.log(
  0 < day && day < 11
    ? "Число в первой декаде"
    : 10 < day && day < 21
    ? "Число во второй декаде"
    : "Число в третьей декаде"
);
...
const dozens = parseInt((num % 100) / 10);
const units = num % 10;
alert(
